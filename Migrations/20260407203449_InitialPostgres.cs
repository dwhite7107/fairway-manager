        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    HomeCourse = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    CaptainPlayerId = table.Column<int>(type: "integer", nullable: false),
                    TeamJoinCode = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TournamentHolePars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TournamentHolePars_Tournaments_TournamentId",
                        column: x => x.TournamentId,
                        principalTable: "Tournaments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerTeams", x => new { x.TournamentId, x.PlayerId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerTeams_Tournaments_TournamentId",
                        column: x => x.TournamentId,
                        principalTable: "Tournaments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scores_TournamentId_PlayerId_HoleNumber",
                table: "Scores",
                columns: new[] { "TournamentId", "PlayerId", "HoleNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Scores_TournamentId_PlayerId_HoleNumber_RoundNumber",
                table: "Scores",
                columns: new[] { "TournamentId", "PlayerId", "HoleNumber", "RoundNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentHolePars_TournamentId",
                table: "TournamentHolePars",
                column: "TournamentId");
